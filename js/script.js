...
function AboutPage() {
    ...
    <div id="imgandauthor">
        <div class="imgiggg" style="background-image:url(imgs/imgs_gif/im1.png)">
            <div class="imgif" style="background-image:url(imgs/imgs_gif/im1.png)">
                <div class="imgiglobal" style="background-image:url(imgs/imgs_gif/im1.png)"></div>
            </div>
        </div>
        <div id="theauthor">
            <div class="firstinfoaut">
                <div class="infoauthor"><div class="winfoauthor">Author</div><div class="xinfoauthor">Rudy Attia</div></div>
                <div class="infoauthor"><div class="winfoauthor">City</div><div class="xinfoauthor">Jerusalem</div></div>
            </div>
            <div class="secondinfoaut">
                <div class="infoauthor"><div class="winfoauthor">Tel</div><div class="xinfoauthor">+972 54-7006555</div></div>
                <div class="infoauthor"><div class="winfoauthor">Mail</div><div class="xinfoauthor">rudy.a24@hotmail.fr</div></div>
            </div>
        </div>
    </div>
    <div id="aboutproject">
        <div id="titleabpr">Project 2 - john bryce - full stack 2018-2019</div><br>
        <div id="lgsused">
        ...
        <div id="idforbtninabout">
            ...
            <button onclick="window.location.href='https://github.com/RudyAttia/Project2.git'" class="btninabout">view code in GitHub</button>
        </div>
    </div>
    `;
    ...
    function fmover(){
        ...
        stint = setInterval(function(){
            $(".imgif").css({"background-image":`url(imgs/imgs_gif/im${j}.png)`});
            i++;
            if(i<9){j=i}
            else if(i>=9){j=18-i}
            if(i===18){
